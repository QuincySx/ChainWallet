...
class SpendP2SHP2WSHTransactionUnitTest {
    ...
    fun spend_p2sh_p2wsh_to_p2pkh() {
        ...
        // https://live.blockcypher.com/btc-testnet/tx/a0a2eccb1b20d3779d92c671a9a01e9b64d15da3cccc1b11a68caa5b505d45dc/
    ...
    fun spend_main_p2sh_p2wsh_to_p2pkh() {
        ...
        val txout1 = Transaction.Output(
            BitcoinInputStream("00e9a43500000000".hexToByteArray())
                .readInt64(),
            convert.convert(
        ...
        val txOut2 = Transaction.Output(
            BitcoinInputStream("c0832f0500000000".hexToByteArray())
                .readInt64(),
            convert.convert(
