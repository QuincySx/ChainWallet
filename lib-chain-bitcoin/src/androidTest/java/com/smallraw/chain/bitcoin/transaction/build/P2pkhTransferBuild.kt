...
class P2pkhTransferBuild {
    ...
    private val btcTransactionBuilder = TransactionBuilder(
        ...
        OutputSetter(),
        TransactionSigner(InputSigner(privateKeyPairProvider))
    )
    ...
    fun test_transfer() {
        ...
        Assert.assertEquals(
            ...
            ""
        )
    }
}