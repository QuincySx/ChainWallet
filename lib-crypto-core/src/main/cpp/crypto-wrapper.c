...
Java_com_smallraw_crypto_core_jni_CryptoJNI_hexToStr(JNIEnv *env,
...
Java_com_smallraw_crypto_core_jni_CryptoJNI_strToHex(JNIEnv *env, jobject thiz,
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_smallraw_crypto_core_jni_CryptoJNI_base58Encode(JNIEnv *env,
                                                                      jobject byteObj /* this */,
                                                                      jbyteArray bytes_jbyteArray,
                                                                      jint data_size_jint) {
...
JNIEXPORT jbyteArray JNICALL
Java_com_smallraw_crypto_core_jni_CryptoJNI_base58Decode(JNIEnv *env, jobject thiz,
                                                                      jstring date_jbyteArray) {
...
JNIEXPORT jstring JNICALL
Java_com_smallraw_crypto_core_jni_CryptoJNI_base58EncodeCheck(JNIEnv *env,
                                                                           jobject byteObj /* this */,
                                                                           jbyteArray bytes_jbyteArray,
                                                                           jint data_size_jint) {
    const char *bytes = (*env)->GetByteArrayElements(env, bytes_jbyteArray, 0);
...
JNIEXPORT jbyteArray JNICALL
Java_com_smallraw_crypto_core_jni_CryptoJNI_base58DecodeCheck(JNIEnv *env,
                                                                           jobject thiz,
                                                                           jstring date_jbyteArray) {
    const char *bytes = (const char *) (*env)->GetStringUTFChars(env, date_jbyteArray, 0);
    int bytesSize = (*env)->GetStringUTFLength(env, date_jbyteArray);
...
JNIEXPORT jbyteArray JNICALL
Java_com_smallraw_crypto_core_jni_CryptoJNI_sha256(JNIEnv *env, jobject thiz,
...
JNIEXPORT jbyteArray JNICALL
Java_com_smallraw_crypto_core_jni_CryptoJNI_doubleSha256(JNIEnv *env, jobject thiz,
                                                                      jbyteArray date_jbyteArray,
                                                                      jint data_size) {
    const unsigned char *date = (*env)->GetByteArrayElements(env, date_jbyteArray, 0);
...
JNIEXPORT jbyteArray JNICALL
Java_com_smallraw_crypto_core_jni_CryptoJNI_ripemd160(JNIEnv *env, jobject thiz,
                                                                   jbyteArray
                                                                   date_jbyteArray,
                                                                   jint data_size) {
...
JNIEXPORT jbyteArray JNICALL
Java_com_smallraw_crypto_core_jni_CryptoJNI_sha3_1256(JNIEnv *env, jobject thiz,
                                                                   jbyteArray date_jbyteArray,
                                                                   jint data_size) {
...
JNIEXPORT jbyteArray JNICALL
Java_com_smallraw_crypto_core_jni_CryptoJNI_doubleSha3_1256(JNIEnv *env, jobject thiz,
                                                                         jbyteArray date_jbyteArray,
                                                                         jint data_size) {
    uint8_t *date = (*env)->GetByteArrayElements(env, date_jbyteArray, 0);
    uint8_t *digest = malloc(SHA3_256_DIGEST_LENGTH);
...
JNIEXPORT jbyteArray JNICALL
Java_com_smallraw_crypto_core_jni_CryptoJNI_keccak_1256(JNIEnv *env, jobject thiz,
                                                                     jbyteArray date_jbyteArray,
                                                                     jint data_size) {
    uint8_t *date = (*env)->GetByteArrayElements(env, date_jbyteArray, 0);
    uint8_t *digest = malloc(SHA3_256_DIGEST_LENGTH);
...
JNIEXPORT jbyteArray JNICALL
Java_com_smallraw_crypto_core_jni_CryptoJNI_doubleKeccak_1256(JNIEnv *env,
                                                                           jobject thiz,
                                                                           jbyteArray date_jbyteArray,
                                                                           jint data_size) {
    uint8_t *date = (*env)->GetByteArrayElements(env, date_jbyteArray, 0);
...
JNIEXPORT jbyteArray JNICALL
Java_com_smallraw_crypto_core_jni_CryptoJNI_hmac_1sha256(JNIEnv *env, jobject thiz,
...
JNIEXPORT jbyteArray JNICALL
Java_com_smallraw_crypto_core_jni_CryptoJNI_hmac_1sha512(JNIEnv *env, jobject thiz,
                                                                      jbyteArray key_jbyteArray,
                                                                      jbyteArray message_jbyteArray,
                                                                      jint key_size,
                                                                      jint message_size) {
...
JNIEXPORT jbyteArray JNICALL
Java_com_smallraw_crypto_core_jni_CryptoJNI_sig_1to_1der(JNIEnv *env, jobject thiz,
...
JNIEXPORT jbyteArray JNICALL
Java_com_smallraw_crypto_core_jni_CryptoJNI_der_1to_1sig(JNIEnv *env, jobject thiz,
