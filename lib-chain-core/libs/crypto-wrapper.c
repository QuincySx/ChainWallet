...
JNIEXPORT jbyteArray JNICALL
Java_com_smallraw_chain_lib_jni_CryptoJNI_00024Companion_base58DecodeCheck(JNIEnv *env,
                                                                           jobject thiz,
                                                                           jstring date_jbyteArray) {
    const char *bytes = (const char *) (*env)->GetStringUTFChars(env, date_jbyteArray, 0);
    int bytesSize = (*env)->GetStringUTFLength(env, date_jbyteArray);
...
JNIEXPORT jbyteArray JNICALL
Java_com_smallraw_chain_lib_jni_CryptoJNI_00024Companion_ripemd160(JNIEnv *env, jobject thiz,
                                                                   jbyteArray
                                                                   date_jbyteArray,
                                                                   jint data_size) {
...
JNIEXPORT jbyteArray JNICALL
Java_com_smallraw_chain_lib_jni_CryptoJNI_00024Companion_doubleKeccak_1256(JNIEnv *env,
                                                                           jobject thiz,
                                                                           jbyteArray date_jbyteArray,
                                                                           jint data_size) {
    uint8_t *date = (*env)->GetByteArrayElements(env, date_jbyteArray, 0);
